...
void sendChecksum(int point1[10], int point2[10]) {
...
void DccLib::updateSpeed(int address, int speed, bool isReverse) {
  int sendAddress[10];
...
void DccLib::updateGroup(int address, bool f0, bool f1, bool f2, bool f3, bool f4, bool f5, bool f6, bool f7, bool f8, bool f9, bool f10, bool f11, bool f12) {
  int sendAddress[10];
  generateAddress(address, sendAddress);
...
DccLib::DccLib(int pinOne, int pinTwo) {
  _pinOne = pinOne;
  _pinTwo = pinTwo;
